...
\begin{minipage}{0.2\textwidth} % Adjust width as needed
    \includegraphics[width=2cm]{RESOURCES/website_logo.png} % Adjust width as needed
\end{minipage}\
\vspace{-1cm} % Adjust this value to position the logo at the top
\hfill
\fontsize{7pt}{9pt}\selectfont % Header font size
\begin{center}\
    \textbf{CUSTOM HEDING} \\
    \textbf{MB 5 PCIU} \\
\end{center}
\fontsize{8pt}{9pt}\selectfont % Restore main font size
% Keep original upper tables unchanged
\noindent\begin{tabular}{|p{5cm}|p{4cm}|p{2.5cm}|p{1.5cm}|p{3cm}|}
    \hline
    \textbf{Name:} sada & \textbf{Age:} 2 years 4 months & \textbf{Gender:} Male & \textbf{Bed:} 10 & \textbf{UHID:} 456789123 \\
    \hline
...
\vspace{-1.50cm} % Dynamic spacing based on font size
    ...
    \begin{tabular}{|p{12cm}|}
        \hline
        \textbf{Sedation, analgesia, and neuromuscular blockade} \\
        \hline
       1. fcdsfsa \\
        \hline
    \end{tabular}
    ...
    \begin{tabular}{|p{7cm}|p{1cm}|p{2cm}|p{2cm}|}
        \hline
        \textbf{Inotropes and Anti-hypertensives} & \textbf{Day} & \textbf{Dose} & \textbf{Volume} \\
        \hline
       1. New Esdfsdfntry & 1 & 0 & 0 \\
        \hline
    \end{tabular}
    \vspace{0.2cm}
